(()=>{var Q={457:(e,n,r)=>{"use strict";r.r(n),r.d(n,{default:()=>S});var c=r(537),s=r.n(c),l=r(645),C=r.n(l),w=C()(s());w.push([e.id,`
/* Styling specific this component can be placed here */
.container[data-v-a769db8c] {
    display: flex;
    flex-direction: row;
    column-gap: 2em;
...
.block[data-v-a769db8c] {
    background-color: #464e57;
}
.block[data-v-a769db8c]:hover {
    background-color: transparent;
}
#event-list[data-v-a769db8c] {
    display: grid;
    grid-template-columns: 1fr 1fr;
}
.binding-style[data-v-a769db8c] {
    font-weight: 700;
    color: #1e90ff;
}
#cancel[data-v-a769db8c],
#accept[data-v-a769db8c] {
    display: block;
}
.button-right[data-v-a769db8c] {
    float: right;
}
.codewhisperer-preview-terms[data-v-a769db8c] {
    text-align: center;
    font-weight: bold;
    text-decoration-line: underline;
}
.table-bordered[data-v-a769db8c] {
    border-collapse: collapse;
}
table[data-v-a769db8c],
th[data-v-a769db8c],
td[data-v-a769db8c] {
